    ...
    <div class="grid grid-cols-1 gap-6 >
        <div class="space-y-6">
            ...
            <form action="{{ route('etudiant.store') }}" method="post">
                ...
                <button type="submit" class="inline-flex items-center gap-2 my-3 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">Enregistrer</button>
            </form>
