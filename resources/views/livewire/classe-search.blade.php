        ...
        <div class="flex items-center gap-3">
            <div class="relative flex-1">
                ...
                <input
                    ...
                    placeholder="Rechercher un classe..."
                />
            </div>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                @if($classes->count() > 0)
                    @foreach ($classes as $classe)
                        <tr class="border-t">
                            <td class="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">{{ $classe->nom_classe }}</td>
                            <td class="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                <div class="flex items-center space-x-3">
                                    <a href="{{ route('classe.edit', $classe->id) }}" class="text-blue-600 hover:text-blue-800 transition-colors" title="Modifier">
